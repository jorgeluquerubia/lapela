...
- Al alcanzar `ends_at`, la interfaz retira inmediatamente las acciones de puja y muestra `Pendiente de cierre` hasta que el mantenimiento persiste el resultado definitivo.
...
| `POST /api/market/mark-all-notifications-read` | Destinatario autenticado | Marcar todas las novedades pendientes del usuario como leídas |
